...
var block_play =
  '<div id="rad_block_play"><img src="' +
  g_playimg +
  '" id="rad_play_btn" onclick="rad_playstop(); return false;" align="absmiddle"></div>';
...
var select =
  '<div style="color: ' +
  g_text_color +
  ';" onclick="return rad_show_stations();" id="rad_select" align="left"><div id="rad_stationname">' +
  '<img src="https://radiobells.com/stations/' +
  img +
...
for (var i = 0; i < rad_stations.length; i++) {
  ...
  select +=
    ...
    '" data-img="' +
    img +
    '" align="left" onclick="return rad_selectthis(this);" onmouseover="this.style.backgroundColor = \'#434242\'" onmouseout="this.style.backgroundColor = \'#2c2c2c\'" class="rad_selection">';

  if (rad_stations[i][2] != undefined) {
    select +=
      '<img src="https://radiobells.com/stations/' +
      rad_stations[i][2] +
      '_70.jpg" class="rad_select_small_image" align="absmiddle">';
  } else {
    select +=
      '<img src="https://radiobells.com/stations/noradio_70.jpg" class="rad_select_small_image" align="absmiddle">';
  }
...
var block_volume =
  '<div id="rad_block_volume"><img src="' +
  g_soundimg +
  '" id="rad_sound_btn" onclick="rad_show_volume(); return false;" align="absmiddle">' +
  '<div id="rad_volume" style="display: none;" align="left">' +
  '<div id="rad_volume_range" onmousemove="volumemove(event);"><div style="height: ' +
  g_volume +
  'px; " id="rad_volume_bar"></div></div>' +
  "</div>" +
  "</div>";

var block_logo =
  '<div id="rad_block_logo" align="center"><a href="https://www.radiobells.com" target="_blank" title="Ð¾Ð½Ð»Ð°Ð¹Ð½ Ñ€Ð°Ð´Ð¸Ð¾"><img src="' +
  rad_plogo +
  '" border="0" id="rad_logo" alt="Ð¾Ð½Ð»Ð°Ð¹Ð½ Ñ€Ð°Ð´Ð¸Ð¾"></a></div>';
...
document.getElementById("radio_container").innerHTML =
  ...
  "; width: " +
  style_rad_width +
  ';" id="rad_player"><div style="height: 28px;">' +
  block_play +
  block_select +
  block_volume +
  //   block_logo +
