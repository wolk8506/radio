...
function currencyA(data) {
  ...
  currencyUsd.innerHTML = `<div class="currency"><img src="../images/usa.png" width="24"><p class="currencyUsd">USD продажа: ${USD.rateBuy} | покупка: ${USD.rateSell}</p></div>`;
  currencyEur.innerHTML = `<div class="currency"><img src="../images/eur.png" width="24"><p class="currencyEur">EUR продажа: ${EUR.rateBuy} | покупка: ${EUR.rateSell}</p></div>`;
  // console.log(arr);
}
